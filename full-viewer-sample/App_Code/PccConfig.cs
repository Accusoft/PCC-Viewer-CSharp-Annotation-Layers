...
namespace Pcc
{
    ...
    public static class PccConfig
    {
        ...
        /// <summary>
        ///     Gets the host of the Prizm Services
        /// </summary>
        public static string webServiceHost { get; private set; }

        /// <summary>
        ///     Gets the port number of the Prizm Services
        /// </summary>
        public static int webServicePort { get; private set; }

        /// <summary>
        ///     Gets the HTTP scheme of the Prizm Services
        /// </summary>
        public static string webServiceScheme { get; private set; }

        /// <summary>
        ///     Gets the path of the Prizm Services
        /// </summary>
        public static string webServicePath { get; private set; }

        /// <summary>
        ///     Gets the XML markups path
        /// </summary>
        public static string markupsPath { get; private set; }

        /// <summary>
        ///     Gets the JSON markup layers path
        /// </summary>
        public static string markupLayerRecordsPath { get; private set; }

        /// <summary>
        ///     Gets the entire URL of PPS
        /// </summary>
        public static string prizmServiceAddress
        {
            get { return string.Format("{0}://{1}:{2}/{3}", webServiceScheme, webServiceHost, webServicePort, webServicePath); }
        }

        /// <summary>
        ///     Gets the ACS API key (optional)
        /// </summary>
        public static string acsApiKey { get; private set; }
